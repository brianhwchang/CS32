...
//  Homework 4
//
//  Created by Brian Chang on 5/27/20.
...
{
    //       You implement this.  Using the same criteria as compareStore,
...
void sortUsingPtrs(vector<Store>& stores, bool comp(const Store*, const Store*))
{
    ...
    {
        stores[i] = *storePtrs[i];      //storing the dereference pointer element
    }
